...
<div class="masterstudy-single-course-modern">
	...
	<div class="masterstudy-single-course-modern__sidebar">
		...
		<button id="reset-progress" data-course-id="<?php echo esc_attr($course_data['course']->id); ?>"
			 data-user-id="<?php echo esc_attr($course_data['current_user_id']); ?>">
				Reset Progress
			</button>
		<div id="reset-loader" style="display: none;">Loading...</div>
		<div id="reset-notification" style="display: none;"></div>
		<?php
